...
export const JOIN_CHATROOM_REQUEST = 'JOIN_CHATROOM_REQUEST';
export const JOIN_CHATROOM_SUCCESS = 'JOIN_CHATROOM_SUCCESS';
export const JOIN_CHATROOM_FAILURE = 'JOIN_CHATROOM_FAILURE';
export const CHECK_PARTICIPANT_REQUEST = 'CHECK_PARTICIPANT_REQUEST';
export const CHECK_PARTICIPANT_SUCCESS = 'CHECK_PARTICIPANT_SUCCESS';
export const CHECK_PARTICIPANT_FAILURE = 'CHECK_PARTICIPANT_FAILURE';
